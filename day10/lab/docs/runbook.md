...
```
freshness_check=FAIL {"status": "FAIL", "latest_exported_at": "2026-04-10T08:00:00", ...}
...
| 5 | Chạy lại với fix bình thường | Xác nhận `hits_forbidden=no`, chunk 3 vào quarantine |
